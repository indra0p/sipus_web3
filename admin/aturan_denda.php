...
if (isset($_POST['update_durasi'])) {
    if (!empty($_POST['durasi'])) {
        ...
        header("location: denda.php?pesan=updated"); exit;
    }
}
...
<head>
    <meta charset="UTF-8">
    <title>Konfigurasi Denda & Durasi - SIPUS POLSA</title>
        ...
        <div class="rule-card">
            <form method="POST">
                ...
                <div style="display:flex; justify-content:space-between;">
                    ...
                    <label><input type="checkbox" name="is_active" <?php echo ($r['is_active'] == 1) ? 'checked' : ''; ?>> Aktif</label>
                </div>
